  ...
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-zinc-950 px-4">
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        >
          <Link href="/rezervacia">
            <Button className="h-12 rounded-lg bg-gold px-8 text-base font-semibold text-zinc-950 hover:bg-gold-light">
              Rezervovať jazdu
            </Button>
          </Link>
          <a href="#cennik">
            <Button
              variant="outline"
              className="h-12 rounded-lg border-zinc-700 px-8 text-base text-zinc-300 hover:border-gold/50 hover:text-white"
            >
              Zobraziť cenník
            </Button>
          </a>
      ...
      <motion.div
        ...
        className="relative z-10 mt-16 grid w-full max-w-3xl grid-cols-2 gap-6 sm:mt-20 sm:grid-cols-4 md:gap-8"
      >
        {stats.map((stat) => (
      ...
      <motion.a
        ...
        className="absolute bottom-8 left-1/2 -translate-x-1/2 text-zinc-600 transition-colors hover:text-gold"
